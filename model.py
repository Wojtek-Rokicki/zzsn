from set_generators import RandomSetGenerator, TopNSetGenerator, FirstKSetGenerator, MLPGenerator
...
def pick_set_generator(config):
    ...
    elif name == 'TopNGenerator':
        cls = TopNSetGenerator
...
class CustomEncoder(nn.Module):
    def __init__(self, cfg: EncoderConfig):
        ...
        self.initial_mlp = MLP(in_dim, hidden, cfg.hidden_initial, cfg.initial_mlp_layers)
